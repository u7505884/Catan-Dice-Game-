...
// FIXME: Task #11
     ...
     * path.
     * @author Ziling Ruan (u7505884), Ta-Wei Chen (u7546144)
     */
    //FIXME: Task #13
    public static String[] pathTo(String target_structure,
        ...
        switch (target_structure.charAt(0)) {
                    ...
                    if (num != 0) {
                        if (num == 1 || num == 2) {
                            ...
                            while (num >0) {
                                ...
                                num = Integer.parseInt((r.lastBuildableStructure).toString().substring(1));
                            }
                        }
                    }
                }
            ...
            case ('S'):
                if (num == 3) {
                    ...
                    path.add(r.toString());
                    while (num > 0) {
                        Road r2 = lroads.get(num);
                        path.add((r2.lastBuildableStructure).toString());
        ...
        String[] a2 = path.stream().toArray(String[]::new);

        List<String> a3 = Arrays.asList(a2);
        List<String> a4 = new ArrayList<>(a3);


        String[] b2 = board_state.split(",");
        List<String> b3 = Arrays.asList(b2);
